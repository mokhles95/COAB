 ...
 <aside class="right-side">
    ...
    <div class="row">
        <div class="col-sm-10">
          ...
          <button type="button" id="create_pdf" class="btn btn-success aaa">Version PDF</button> <a href="../function/user.php?action_type=delete&id=<?php echo $user['id_emp']; ?>" onclick="return confirm('voulez-vous vraiment supprimer  <?php echo $user[2];?> ?');"><button type="button" class="btn btn-danger aaa">Supprimer</button> </a>
<br>
  ...
  <br>
   ...
   <div class="media thumbnail">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading"><p>congé <?php echo $row3[6]; ?> 
