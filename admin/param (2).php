...
; ?></p>
 ...
 <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
						 ...
						 <div class=" add-task-row">
                                 <div class="form-group">
                                          <label for="exampleInputPassword1">Nouvelle compétence</label>
                                          <input type="text" class="form-control" id="nomcomp" placeholder="compétence..." required>
                                      </div>  <a id="addcomp"class="btn btn-success btn-sm pull-left" >Ajouter</a> 
                ...
                <div class="panel-heading">Expériences</div>
                <div class="panel-body">
								   <?php
							   $sql3 = "SELECT * FROM `experience` where idUser = '$id' "; 
		                       $req3 = $con -> query($sql3);
							   $count1 = 0 ;
							   while($row3 = $req3 -> fetch_array () )
{
	$count1 ++ ;
 ?>
   ...
   <div class="media thumbnail">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading"> <?php echo $row3[6]; ?> 
                            <small>Début : <?php echo $row3[2]; ?>  , Fin : <?php echo $row3[3]; ?>  </small>
							<input type="hidden" id="idexp" value="<?php echo $row3[1]; ?>" >
							 <button id="suppexp" class="btn btn-default btn-xs pull-right"><i class="fa fa-times"></i></button>
                        </h4>
                       <?php echo $row3[7]; ?> 
...
<div class=" add-task-row">
                                  <a id="affichexp"class="btn btn-success btn-sm pull-left" >Nouvelle experience</a><br>
