...
; ?></p>
            ...
            $db = new DB();
            $users = $db->getRows('mh_conge',array('order_by'=>'id_c DESC'));
            if(!empty($users)){  foreach($users as $user){ ?>
                                ...
                                <tr>
								  ...
								  <td>
                                  <a class="btn btn-success btn-xs pull-left" href="dconge.php?id=<?php echo $user['id_c']; ?>;">Détails</a>
            ...
            $users = $db->getRows('mh_absence',array('order_by'=>'id_ab DESC'));
            if(!empty($users)){  foreach($users as $user){ ?>
                                      
                                <tr>
                                  <td> <?php echo $user["nom_emp"]; ?> </td>
                                  <td> <?php echo $user["dateD_A"]; ?> </td>
								 
								   <td> <?php echo $user["nbr_h"]; ?>  </td>
								  <td> <?php echo $user["rep_rh"]; ?>  </td>
                                  ...
                                  <td>
                                    <a class="btn btn-success btn-xs pull-left" href="../function/class.demandeAB.php?action_type=edit&id=<?php echo $user['id_ab']; ?>&rep=valider"onclick="return confirm('voulez-vous vraiment accepter cette demande?');">Accepter</a>
                                  <a class="btn btn-danger btn-xs pull-left" href="../function/class.demandeAB.php?action_type=edit&id=<?php echo $user['id_ab']; ?>&rep=Réfuser"onclick="return confirm('voulez-vous vraiment réfuser cette demande?');">Réfuser</a>
